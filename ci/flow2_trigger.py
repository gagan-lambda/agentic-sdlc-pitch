...
# TODO: update IDs after re-running flow2_pipeline.py against saucedemo objectives
TEST_CASES = [
    {"id": "01KW1T9WTR2C22NDSWVHJAY86H", "name": "SC-001: Add to cart changes button to Remove"},   # TC-41427
    {"id": "01KW1T7RGT4KZVVEWAEAD2D7M9", "name": "SC-002: Cart page shows item name and price"},    # TC-41425
    {"id": "01KW1NS775V5Q7102744G7PT03", "name": "SC-003: Remove item restores Add to cart button"}, # TC-41389
    {"id": "01KW1TBFDPNK3FEFMVJE4N7E6B", "name": "SC-004: Sort by price shows cheapest first"},     # TC-41428
    {"id": "01KW1TE579VJNZMTSCFGQNNFW6", "name": "SC-005: Catalog page loads with product listings"},# TC-41430
]
